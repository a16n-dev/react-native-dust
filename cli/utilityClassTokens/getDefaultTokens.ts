...
const defaultTokens: styleToken[] = [
  ...
  // Opacity tokens
  { key: "opacity_0", values: [["opacity", "0"]] },
  { key: "opacity_10", values: [["opacity", "10"]] },
  { key: "opacity_25", values: [["opacity", "0.25"]] },
  { key: "opacity_30", values: [["opacity", "0.30"]] },
  { key: "opacity_40", values: [["opacity", "0.4"]] },
  { key: "opacity_50", values: [["opacity", "0.5"]] },
  { key: "opacity_60", values: [["opacity", "0.6"]] },
  { key: "opacity_70", values: [["opacity", "0.7"]] },
  { key: "opacity_75", values: [["opacity", "0.75"]] },
...
export function getDefaultTokens(config: Config, whitelist?: string[]) {
  ...
  if (!whitelist) {
    return allDefaultTokens;
  }
  return allDefaultTokens.filter((token) => whitelist.includes(token.key));
}
